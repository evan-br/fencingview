"""
Quick test script for FencingView analysis.

Usage:
    python test_script.py                    # Use default video "epee1.mp4"
    python test_script.py path/to/video.mp4 # Use custom video file
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python test_script.py                        # Analyze epee1.mp4 (default)
  python test_script.py path/to/match.mp4      # Analyze custom video
  python test_script.py --no-preview video.mp4 # Analysis without preview
        """
    )
    ...
    if not os.path.exists(args.video):
        ...
        print(f"  python test_script.py {args.video}")
        sys.exit(1)
